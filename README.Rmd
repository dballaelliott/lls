...
You can directly install `lls` from the source code (i.e. the contents of this repo).
To do so, save the `lls` folder somewhere on your computer and then you can install from the source with `install.packages`.
...
When the package is live, you can install the most recent version of `lls` from GitHub with:
